...
//            "A required component (data storage module) could not be loaded. You may need to restart your
//            computer."
//        case .noCertificateModule:
//            "A required component (certificate module) could not be loaded. You may need to restart your
//            computer."
//        case .noPolicyModule:
...
//            "Internal error when a required entitlement isn't present, client has neither application-identifier
//            nor keychain-access-groups entitlements."
//        case .upgradePending:
//            "Error returned if keychain database needs a schema migration but the device is locked, clients
//            should wait for a device unlock notification and retry the command."
